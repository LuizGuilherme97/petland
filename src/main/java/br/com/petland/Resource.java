...
public class Resource<T> {
	...
	public static <T extends Object> Resource<T> notFound(T data) {
		return new Resource<T>(ResponseStatus.NOT_FOUND.status(), ResponseStatus.NOT_FOUND.code(), asList("Pet not found."), data);
	}
